...
const Order = () => {
    ...
    const [loading , setLoading] = useState(false)
     ...
     const fetchOrder = async () => {
        ...
        try {
            setLoading(true)
            const res = await  axios.get("https://yati-perfume-backend.onrender.com/api/order")
  ...
  <div key={order._id} className="order-card">
    ...
    <div className="order-ending">
      <FiTrash2 onClick={() => deleteOrder(order._id)} size={20} color='red' className="cartt-icon" />
